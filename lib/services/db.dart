  ...
  static Future setData() async {
    Map exampleTransactions = {
      ...
      "tr3": {
        ...
        'edited': 123,
        'currency': 'brl',
        'dateTime': 1000 * 60 * 60 * 24 * 365 * 56,
        'totalValue': 112.5,
        'accountPrimary': "acc4",
        'description': "description",
        'accountSecondary': "acc1",
        'categories': {"cat1": 2, "cat2": 10.5},
        'nShares': null,
        'pricePerShare': null,
        'assetName': null,
        'type': 'income',
      ...
      "t6": {
        ...
        'edited': 123,
        'currency': 'brl',
        'dateTime': 1000 * 60 * 60 * 24 * 365 * 57,
        'totalValue': 112.5,
        'accountPrimary': "acc4",
        'description': "description",
        'accountSecondary': "acc1",
        'categories': {"cat1": 2, "cat2": 15.5},
        'nShares': null,
        'pricePerShare': null,
        'assetName': null,
        'type': 'income',
      ...
      "t4": {
        ...
        'edited': 123,
        'currency': 'brl',
        'dateTime': 1000 * 60 * 60 * 24 * 365 * 58,
        'totalValue': 112.5,
        'accountPrimary': "acc4",
        'description': "description",
        'accountSecondary': "acc1",
        'categories': {"cat1": 2, "cat2": 9.5},
        'nShares': null,
        'pricePerShare': null,
        'assetName': null,
        'type': 'income',
      ...
      "t5": {
        ...
        'edited': 123,
        'currency': 'brl',
        'dateTime': 1000 * 60 * 60 * 24 * 365 * 53,
        'totalValue': 112.5,
        'accountPrimary': "acc4",
        'description': "description",
        'accountSecondary': "acc1",
        'categories': {"cat1": 2, "cat2": 20.5},
        'nShares': null,
        'pricePerShare': null,
        'assetName': null,
        'type': 'income',
      ...
      "t7": {
        ...
        'edited': 123,
        'currency': 'brl',
        'dateTime': 1000 * 60 * 60 * 24 * 365 * 59,
        'totalValue': 112.5,
        'accountPrimary': "acc4",
        'description': "description",
        'accountSecondary': "acc1",
        'categories': {"cat1": 10, "c3": 0.5},
        'nShares': null,
        'pricePerShare': null,
        'assetName': null,
        'type': 'income',
      ...
      "t8": {
        ...
        'edited': 123,
        'currency': 'brl',
        'dateTime': 1000 * 60 * 60 * 24 * 365 * 60,
        'totalValue': 112.5,
        'accountPrimary': "acc4",
        'description': "description",
        'accountSecondary': "acc1",
        'categories': {"c3": 5, "cat2": 9},
        'nShares': null,
        'pricePerShare': null,
        'assetName': null,
        'type': 'income',
